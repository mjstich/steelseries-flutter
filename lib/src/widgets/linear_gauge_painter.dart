...
import 'package:steelseries_flutter/src/draw/linear.dart';
...
class RenderLinearGauge extends RenderBox {
  ...
  bool hitTestSelf(Offset position) {
    ...
    if (linearPath.contains(calulatedPosition)) {
      return true;
    } else if (linearPath.contains(position)) {
      return true;
    } else {
      return false;
    }
    // Return false if the position is outside the linear gauge
  }
